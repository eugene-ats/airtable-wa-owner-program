...
exports.ExposeStore = (moduleRaidStr) => {
    ...
    window.Store = Object.assign({}, (!window.mR.findModule((m) => (m.Call && m.Chat)).length ? window.mR.findModule((m) => ( m.default && m.default.Chat))[0].default : window.mR.findModule((m) => (m.Call && m.Chat))[0]));// window.Store = Object.assign({}, window.mR.findModule(m => m.default && m.default.Chat)[0].default);
    window.Store.AppState = window.mR.findModule('Socket')[0].Socket;
    window.Store.Conn = window.mR.findModule('Conn')[0].Conn;
    window.Store.BlockContact = window.mR.findModule('blockContact')[0];
    window.Store.Call = (!window.mR.findModule((m) => (m && m.Call)).length ? window.mR.findModule((module) => module.default && module.default.Call)[0].default.Call : window.mR.findModule((m) => (m && m.Call))[0].Call);//window.Store.Call = window.mR.findModule((module) => module.default && module.default.Call)[0].default.Call;
    window.Store.Cmd = window.mR.findModule('Cmd')[0].Cmd;
    window.Store.CryptoLib = window.mR.findModule('decryptE2EMedia')[0];
    window.Store.DownloadManager = window.mR.findModule('downloadManager')[0].downloadManager;
    window.Store.GroupMetadata = (!window.mR.findModule((m) => (m && m.GroupMetadata)).length ? window.mR.findModule((module) => module.default && module.default.GroupMetadata)[0].default.GroupMetadata : window.mR.findModule((m) => (m && m.GroupMetadata))[0].GroupMetadata);//window.Store.GroupMetadata = window.mR.findModule((module) => module.default && module.default.handlePendingInvite)[0].default;//window.Store.GroupMetadata = window.mR.findModule('GroupMetadata')[0].default.GroupMetadata;
    ...
    window.Store.MsgKey = (!window.mR.findModule((m) => (m && m.fromString)).length ? window.mR.findModule((m) => (m.default && m.default.fromString) ? m.default : null)[0].default : window.mR.findModule((m) => (m && m.fromString))[0]);//window.Store.MsgKey = window.mR.findModule((module) => module.default && module.default.fromString)[0].default;
    window.Store.OpaqueData = (!window.mR.findModule((m) => (m && m.createFromData)).length ? window.mR.findModule((m) => (m.default && m.default.createFromData) ? m.default : null)[0].default : window.mR.findModule((m) => (m && m.createFromData))[0]);//window.Store.OpaqueData = window.mR.findModule(module => module.default && module.default.createFromData)[0].default;
    ...
    window.Store.UploadUtils = (!window.mR.findModule((m) => (m && m.encryptAndUpload)).length ? window.mR.findModule((m) => (m.default && m.default.encryptAndUpload) ? m.default : null)[0].default : window.mR.findModule((m) => (m && m.encryptAndUpload))[0]);//window.Store.UploadUtils = window.mR.findModule((module) => (module.default && module.default.encryptAndUpload) ? module.default : null)[0].default;
    window.Store.UserConstructor = (!window.mR.findModule((m) => (m && m.prototype && m.prototype.isServer && m.prototype.isUser)).length ? window.mR.findModule((m) => (m.default && m.default.prototype && m.default.prototype.isServer && m.default.prototype.isUser) ? m.default : null)[0].default : window.mR.findModule((m) => (m && m.prototype && m.prototype.isServer && m.prototype.isUser))[0]);//window.Store.UserConstructor = window.mR.findModule((module) => (module.default && module.default.prototype && module.default.prototype.isServer && module.default.prototype.isUser) ? module.default : null)[0].default;
    ...
    window.Store.LinkPreview = window.mR.findModule((m) => (m.getLinkPreview && !m.clearMsgGetterCacheFor && !m.getAck && !m.getVcard))[0];//window.Store.LinkPreview = window.mR.findModule('getLinkPreview')[0];
